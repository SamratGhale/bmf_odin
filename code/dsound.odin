...
//NOTE: totallly a library file i got from github
package main
...
foreign import dsound "system:dsound.lib"

foreign dsound{
    DirectSoundCreate::proc(lpGuid: win32.LPGUID, ppDS:^^IDirectSound, pUnkOuter:rawptr)->win32.HRESULT ---
}
